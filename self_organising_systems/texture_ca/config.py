...
cfg.texture_ca.lr_decay = 0
cfg.texture_ca.lr_decaya = 1000 # min
cfg.texture_ca.lr_decayb = 3000 # max
cfg.texture_ca.lr_decayc = 100 # step
cfg.texture_ca.rollout_len_min = 32
cfg.texture_ca.rollout_len_max = 64
cfg.texture_ca.train_steps = 1000
cfg.texture_ca.gradnorm = True
cfg.texture_ca.q = 0.0
cfg.texture_ca.qa = 1.0 # min
cfg.texture_ca.qb = 3.0 # max
cfg.texture_ca.qc = 0.5 # step
...
cfg.texture_ca.hidden_viz_group = True # Group the hidden states into RGB when vizualizing
